...
public interface KeyWordSequenceService {
    ...
    ArrayList<Paper> getPapers(String path) throws IOException;
    ...
    ArrayList<Node> getNodes(ArrayList<Paper> papers);

    ArrayList<Link> getLinks(ArrayList<Paper> papers, ArrayList<Node> nodes);
